...
Этот документ нужен как контрольный список, чтобы при переносе Warcraft II в Godot не потерять игровую механику. В него нельзя добавлять механику "по ощущениям". Каждая строка должна иметь источник в Warcraft II, Wargus/Stratagus или проверку в оригинальной игре.

## Правила источников

Основной локальный источник фактов сейчас: `C:\Users\UZER\Coding\Projects\wargus`.
