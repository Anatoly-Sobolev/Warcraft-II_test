...
Wargus используется как reference source для структуры анимаций. В Godot-проекте
описания анимаций хранятся в собственной data-driven схеме.
...
- оригинальные ассеты в `content/assets/` используются как временные
  `original_placeholder` и заменяются новыми ассетами через manifest/catalog.
...
8. Ассет проверен на игровом zoom и на мобильном графическом профиле ОС Аврора.
