...
- Нельзя добавлять оригинальные ассеты Warcraft II как финальные ассеты проекта.
  Они допускаются только как временные `original_placeholder` для разработки
  визуальной системы, с записью в asset manifest и планом замены на новые ассеты.
...
- Нельзя считать `original_placeholder` финальным ассетом или использовать его
  как основание для изменения игровой механики.
